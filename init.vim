...
nnoremap <silent> dg <cmd>TroubleToggle<CR>
...
" Use tab as 2 spaces for SQL
autocmd Filetype sql setlocal tabstop=2 softtabstop=2 shiftwidth=2 expandtab smarttab
